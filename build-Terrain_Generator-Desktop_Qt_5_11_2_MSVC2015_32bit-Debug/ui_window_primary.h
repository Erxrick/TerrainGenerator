...
public:
    ...
    void setupUi(QMainWindow *Window_Primary)
    {
        ...
        sizePolicy7.setHeightForWidth(CurrentSelectionPage->sizePolicy().hasHeightForWidth());
        CurrentSelectionPage->setSizePolicy(sizePolicy7);
        horizontalLayout = new QHBoxLayout(CurrentSelectionPage);
        horizontalLayout->setSpacing(0);
        horizontalLayout->setObjectName(QStringLiteral("horizontalLayout"));
        horizontalLayout->setContentsMargins(0, 0, 0, 0);
        lblSelectionImage = new ImageHolder(CurrentSelectionPage);
        lblSelectionImage->setObjectName(QStringLiteral("lblSelectionImage"));
        lblSelectionImage->setMouseTracking(false);

        horizontalLayout->addWidget(lblSelectionImage);
    ...
    void retranslateUi(QMainWindow *Window_Primary)
    {
        ...
        lblSelectionImage->setText(QString());
